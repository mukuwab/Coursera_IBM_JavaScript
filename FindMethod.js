//Find Method
    //Returns the first element that satisfies a speciifed condition
    //useful for searching specific data
    
//Find an employee with a specific IS
...
const employees = [
    ...
    {id: 1, name 'Charlie', Eid: 'EMP003', 'Contact details':'charlie@example.com',Role:'Analyst',Designation:'Data Analyst',Experience:'2 years'},
    ];
    
    const employee = employee.find((e) ==> e.id ===2);
    console.log(`Details of the employee/name: ${employee.name}\nEid:
